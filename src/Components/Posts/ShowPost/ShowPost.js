...
import './ShowPost.css'
import avtar from '../../../assets/sumana.jpeg'
            ...
            <div className="showblog_card card">
                <div className="showblog_card_image"
                    ...
                    <div className="show_auth_img">
                        <Link to={"/public/" + post.user?.username} style={{ backgroundImage: `url(${post.user?.imagePath ? post.user.imagePath : avtar})` }}>By Aniket</Link>
                    </div>
                </div>
